...
public class Tomcat {
     ...
     * <p>
     * Alternatively, you can construct a Connector and set any params, then call addConnector(Connector)
     *
     ...
     *
     * @deprecated Use {@link #addWebapp(Host, String, String, LifecycleListener)} instead
     */
    @Deprecated
